...
# Constants
# Note: Forced to give a simpler path
# because the test would fail otherwise.
# PATH = os.path.abspath("./db/jobs.sqlite")
PATH = "db/jobs.sqlite"
...
@app.route('/jobs')
def jobs():
    # Note: Had to pass the string directly because the
